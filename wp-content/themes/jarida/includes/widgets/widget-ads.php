...
class ads300_100_widget extends WP_Widget {
	function ads300_100_widget() {
		...
		parent::__construct( 'ads300_100-widget',theme_name .' - Ads 300*100', $widget_ops, $control_ops );
	}
...
class ads300_250_widget extends WP_Widget {
	function ads300_250_widget() {
		...
		parent::__construct( 'ads300_250-widget',theme_name .' - Ads 300*250', $widget_ops, $control_ops );
	}
