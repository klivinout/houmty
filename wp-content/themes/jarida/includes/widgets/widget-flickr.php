...
class flickr_photos extends WP_Widget {
	...
	function flickr_photos() {
		...
		parent::__construct( 'flickr_photos-widget',theme_name .' - Flickr', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'flickr_title' ); ?>" name="<?php echo $this->get_field_name( 'flickr_title' ); ?>" value="<?php if( !empty($instance['flickr_title']) ) echo $instance['flickr_title']; ?>" class="widefat" type="text" />
		</p>
		<p>
